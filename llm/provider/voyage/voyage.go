...
func voyageCatalog() []llm.ModelInfo {
	...
	return []llm.ModelInfo{
		// default; supports 256/512/1024/2048 via OutputDimension
		{ID: "voyage-3.5", Capabilities: embed, ContextWindow: 32000, Dimensions: 1024},
		// default; supports 256/512/1024 via OutputDimension
		...
		// default output dimension per Voyage docs; supports OutputDimension override
